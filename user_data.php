                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                        <img src="assets/<?= $row["foto"] ?>" width="100" class="rounded" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px;">
                                <?php
                                    }
                                }
                                ?>
                            ...
                            <td>
                                <a href="#modalEdit" title="edit" class="badge rounded-pill text-bg-success p-3" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["id"] ?>"><i class="bi bi-pencil bi-4x"></i></a>
                                <a href="#modalHapus" title="delete" class="badge rounded-pill text-bg-danger p-3" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["id"] ?>"><i class="bi bi-x-circle bi-4x"></i></a>
