...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="."><b>Daily Journal</b></a>
        <button
    ...
    <footer class="text-center p-3 bg-dark-subtle footer bottom">
    <div>
        <a href="https://www.instagram.com/adin_nhd"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6285227570222"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>M. Alauddin Nuurul Hudaa &copy; 2024</div>
    </footer>
